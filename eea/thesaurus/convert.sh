...
java -jar ../../web/target/geonetwork/WEB-INF/lib/saxon-9.1.0.8b-patch.jar -s:rod-instruments-$YEAR.rdf -xsl:rodinstrument2skos.xsl -o:../../web/src/main/webapp/WEB-INF/data/config/codelist/external/thesauri/theme/eu-applicable-legislation.rdf
