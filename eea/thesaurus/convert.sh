...
curl https://rod.eionet.europa.eu/obligations/rdf --output rod2023.rdf

xsltproc -o ../../web/src/main/webapp/WEB-INF/data/config/codelist/external/thesauri/theme/rod-eionet-europa-eu.rdf eeardf2skos.xsl rod2023.rdf
