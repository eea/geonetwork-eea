  ...
  <xsl:template match="/">
    ...
    <message:GenericMetadata
      ...
      <message:Header>
        ...
        <message:Source>
          <xsl:value-of
            select="($dataProvider/gmd:organisationName/gco:CharacterString/text(), util:getNodeName('', $language, true()))[1]"/>
        </message:Source>
      </message:Header>
        ...
        <metadata:AttributeValueSet>
          ...
          <metadata:ReportedAttribute conceptID="INDICATOR">
            ...
            <metadata:ReportedAttribute conceptID="DATA_DESCR">
              <metadata:Value>
                <xsl:value-of select="$metadata/gmd:identificationInfo/*/gmd:abstract/gco:CharacterString"/>
              </metadata:Value>
            </metadata:ReportedAttribute>

            <xsl:for-each
              select="$metadata/gmd:identificationInfo/*/gmd:descriptiveKeywords[contains(*/gmd:thesaurusName/*/gmd:title/*/text(), 'Unit of measure')]/*/gmd:keyword">
            ...
            <xsl:for-each
              select="$metadata/gmd:identificationInfo/*/gmd:descriptiveKeywords[contains(*/gmd:thesaurusName/*/gmd:title/*/text(), 'Reference period')]/*/gmd:keyword">
          ...
          <metadata:ReportedAttribute conceptID="FREQ_TIMELINESS">
            ...
            <xsl:for-each
              select="$metadata/gmd:dataQualityInfo/*/gmd:report/*[gmd:nameOfMeasure/gco:CharacterString = 'Frequency of dissemination']">
            ...
            <xsl:for-each
              select="$metadata/gmd:dataQualityInfo/*/gmd:report/*[gmd:nameOfMeasure/gco:CharacterString = 'Timeliness']">
              <xsl:call-template name="sdmx-measure">
          ...
          <metadata:ReportedAttribute conceptID="COVERAGE_COMPARABILITY">
            <metadata:Value></metadata:Value>
            <xsl:for-each
              select="$metadata/gmd:dataQualityInfo/*/gmd:report/*[gmd:nameOfMeasure/gco:CharacterString = 'Reference area']">
              <xsl:call-template name="sdmx-measure">
            ...
            <xsl:for-each
              select="$metadata/gmd:dataQualityInfo/*/gmd:report/*[gmd:nameOfMeasure/gco:CharacterString = 'Comparability - geographical']">
              <xsl:call-template name="sdmx-measure">
            ...
            <xsl:for-each
              select="$metadata/gmd:dataQualityInfo/*/gmd:report/*[gmd:nameOfMeasure/gco:CharacterString = 'Time coverage']">
              <xsl:call-template name="sdmx-measure">
            ...
            <xsl:for-each
              select="$metadata/gmd:dataQualityInfo/*/gmd:report/*[gmd:nameOfMeasure/gco:CharacterString = 'Comparability - over time']">
              <xsl:call-template name="sdmx-measure">
