  ...
  <sch:ns prefix="xsi" uri="http://www.w3.org/2001/XMLSchema"/>
    ...
    <sch:pattern>
      ...
      <sch:rule context="//mdb:MD_Metadata|//*[@gco:isoType='mdb:MD_Metadata']">
        ...
        -->
        <sch:let name="hl"
                 value="mdb:metadataScope/*/mdb:resourceScope/*/@codeListValue"/>
        ...
        -->
        <sch:let name="srs"
                 value="string-join(mdb:referenceSystemInfo/*/mrs:referenceSystemIdentifier/*/
                                mcc:code/*, ',')"/>
        <sch:let name="countSrs"
                 value="count(mdb:referenceSystemInfo/*/mrs:referenceSystemIdentifier/*/
                                mcc:code/gcx:Anchor[starts-with(@xlink:href, 'http://www.opengis.net/def/crs/EPSG/0/')])"/>
    ...
    <sch:pattern>
        ...
        <sch:rule context="//mri:MD_DataIdentification">
          ...
          <!-- MD_Metadata/identificationInfo/*/citation/*/title. Is mandatory for EEA.
            ...
            -->
            <sch:let name="title"
                value="mri:citation/*/cit:title/gco:CharacterString"/>
          ...
          <sch:let name="creationDate"
                   value="mri:citation/*/cit:date/
                *[cit:dateType/cit:CI_DateTypeCode/@codeListValue='creation']/cit:date/gco:*/text()"/>
          ...
          <sch:report test="normalize-space($creationDate[1]) != ''"><sch:value-of
            ...
            <sch:let name="publicationDate"
                value="mri:citation/*/cit:date/
                *[cit:dateType/cit:CI_DateTypeCode/@codeListValue='publication']/cit:date/gco:*/text()"/>
            <sch:let name="availableOnWebSite"
                value="count(../../mdb:distributionInfo/*/mrd:transferOptions/*/mrd:onLine/*/cit:linkage
                /gco:CharacterString[contains(., '://www.eea.europa.eu/data-and-maps/data')]) > 0"/>
            <sch:let name="url"
                value="../../mdb:distributionInfo/*/mrd:transferOptions/*/mrd:onLine/*/cit:linkage
                /gco:CharacterString[contains(., '://www.eea.europa.eu/data-and-maps/data')]"/>
            ...
            <sch:let name="edition"
                value="mri:citation/*/cit:edition/gco:CharacterString"/>
            <!--<sch:let name="editionInDataLink"
                value="count(../../mdb:distributionInfo/*/mrd:transferOptions/*/mrd:onLine/*
                              [(gmd:protocol/gco:CharacterString = 'EEA:FILEPATH' or
                                gmd:protocol/gco:CharacterString = 'EEA:FOLDERPATH')
                               and contains(cit:linkage/gco:CharacterString, concat('_rev', $edition))]) > 0"/>-->
            ...
            <sch:let name="abstract"
                value="mri:abstract/gco:CharacterString"/>
            ...
            <sch:let name="aPointOfContact"
                value="count(mri:pointOfContact[*/cit:role/*/@codeListValue='pointOfContact']) > 0"/>
            ...
            <sch:let name="aCustodian"
                value="count(mri:pointOfContact[*/cit:role/*/@codeListValue='custodian']) > 0"/>
            ...
            <sch:let name="atLeastOneKeywordFromEEATopics"
                     value="count(mri:descriptiveKeywords/*[contains(mri:thesaurusName/*/cit:title/(gco:CharacterString|gcx:Anchor), 'EEA topics')]
            ...
            <sch:let name="atLeastOneKeywordFromEEA"
                value="count(mri:descriptiveKeywords/*[contains(mri:thesaurusName/*/cit:title/(gco:CharacterString|gcx:Anchor), 'EEA keyword list')]
                /mri:keyword[(gco:CharacterString|gcx:Anchor) != ''])"/>
          ...
          <sch:let name="atLeastOneSpatialScope"
                   value="count(mri:descriptiveKeywords/*[contains(mri:thesaurusName/*/cit:title/(gco:CharacterString|gcx:Anchor), 'Spatial scope')]
                /mri:keyword[* != ''])"/>
          ...
          <sch:let name="atLeastOneKeywordFromGEMET"
                   value="count(mri:descriptiveKeywords/*[contains(mri:thesaurusName/*/cit:identifier/*/mcc:code/*:Anchor/text(), 'external.theme.gemet')]
                /mri:keyword[(gco:CharacterString|gcx:Anchor) != ''])"/>
          ...
          <sch:let name="atLeastOneKeywordFromRegions"
                   value="count(mri:descriptiveKeywords/*[contains(mri:thesaurusName/*/cit:identifier/*/mcc:code/*:Anchor/text(), 'external.place.regions')]
                /mri:keyword[(gco:CharacterString|gcx:Anchor) != ''])"/>
          ...
          <sch:let name="temporalResolutionKeyword"
                   value="mri:descriptiveKeywords/*[contains(mri:thesaurusName/*/cit:identifier/*/mcc:code/*:Anchor/text(), 'local.temporal.temporal-update')]
                /mri:keyword/(gco:CharacterString|gcx:Anchor)[.!='']"/>
          ...
          <sch:let name="resourceAConstraints"
              value="mri:resourceConstraints/mco:MD_LegalConstraints[mco:accessConstraints]/mco:otherConstraints/*[.!='']"/>
          ...
          <sch:let name="resourceUConstraints"
                   value="mri:resourceConstraints/mco:MD_LegalConstraints[mco:useConstraints]/mco:otherConstraints/*[.!='']"/>
          ...
          <sch:let name="spatialRepresentationType"
                   value="mri:spatialRepresentationType/*/@codeListValue[.!='']"/>
          ...
          <sch:let name="spatialResolutionConcat"
                   value="string-join(mri:spatialResolution//*[. != ''], '')"/>
          ...
          <sch:let name="temporalElement"
              value="normalize-space(string-join(mri:extent/*/gex:temporalElement, ''))"/>
