...
GeoNetwork.map.BACKGROUND_LAYERS = [
    ...
    // TODOEEA : Add EEA background map layers
   new OpenLayers.Layer.WMS("World coverage", "http://gaur.eea.europa.eu/cgi-bin/mapserv?map=/var/www/natural_earth/10m_physical/base_hydro_admin.map", {layers: 'ne_background', format: 'image/jpeg'}, {isBaseLayer: true}),
   new OpenLayers.Layer.WMS("World coverage", "http://gaur.eea.europa.eu/cgi-bin/mapserv?map=/var/www/natural_earth/10m_physical/base_hydro_admin.map", {layers: 'NE_Hydrography', format: 'image/png', transparent: 'true'})
];
