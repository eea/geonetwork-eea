      ...
      var defaultConfig = {
        ...
        mods: {
          ...
          search: {
            ...
            moreLikeThisFilter: "-cl_status.key:(obsolete)",
            moreLikeThisConfig: {
              more_like_this: {
                like: [
                  {
          ...
          map: {
            ...
            switcherProjectionList: [
              ...
              },
              {
                ...
                code: "EPSG:3035",
                extent: [
                  -146473.1132416539, 210594.55713179847, 7824928.564455923,
                  6928130.515709829
                ],
                worldExtent: [-35.58, 24.6, 44.83, 84.17],
                resolutions: [],
          ...
          recordview: {
            ...
            collectionTableConfig: {
              ...
              columns:
                "resourceTitle,cl_status[0].key,format,link/name:Direct download.*,link/protocol:ESRI:.*,link/protocol:OGC:.*"
            },
            distributionConfig: {
              // 'layout': 'tabset',
              layout: "",
